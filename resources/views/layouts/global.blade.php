...
<body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">SPP</a>
    ...
    <aside class="app-sidebar">
        <ul class="app-menu">
            ...
            <li class="nav-item">
                <a class="app-menu__item" href="{{route('classrooms.index')}}">
                    <i class="app-menu__icon fas fa-school"></i>
                    <span class="app-menu__label">Manage Kelas</span></a>
            </li>

            <li class="nav-item">
                <a class="app-menu__item" href="{{route('spps.index')}}">
                    <i class="app-menu__icon fas fa-list"></i>
                    <span class="app-menu__label">Manage Spp</span></a>
            </li>

            <li class="nav-item">
                <a class="app-menu__item" href="{{route('students.index')}}">
                    <i class="app-menu__icon fas fa-graduation-cap"></i>
                    <span class="app-menu__label">Manage Siswa</span></a>
            </li>

            @endcan

            <li class="nav-item">
                <a class="app-menu__item" href="{{route('orders.index')}}">
                    <i class="app-menu__icon fas fa-file-invoice"></i>
                    <span class="app-menu__label">Pembayaran</span></a>
            </li>
